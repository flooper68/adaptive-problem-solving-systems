...
- `design-rules.md` — rules for writing any process, learned from retrospectives
- `sessions/intake.md` — session type `aps-intake`: receive inputs from one source and capture each by kind
...
- `sessions/dogfooding.md` — session type `aps-dogfooding`: one observation, recorded and fixed in the same sitting
- `sessions/retrospective.md` — check whether one process works and change it from evidence
