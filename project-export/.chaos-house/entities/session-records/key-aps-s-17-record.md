...
entity:
  identity:
    type: slug
    value: key-aps-s-17-record
  kind: session-record
kind: session-record
value:
  endedAt: 2026-07-26T23:59:59.999Z
  outcome: completed
  session: session:key:APS-S-17
---
...
Repository import provenance: {"sourceCommit":"43b9f6918677ef654578c2276e1c8e4d615fcbf7","sourcePath":"operations/streams/working-sessions/2026-07-26-open-problem-review.md","legacyId":"apss.session.open-problem-review"}

---

[repository-import:session:apss.session.open-problem-review@43b9f6918677ef654578c2276e1c8e4d615fcbf7:operations/streams/working-sessions/2026-07-26-open-problem-review.md]
