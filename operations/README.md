...
- `processes/` defines working sessions, feedback and backlog intake and
  grooming, AI agent tasks, the complete framework loop, validation,
  compilation, adaptation, and release.
...
- `streams/` explains how raw operational evidence is retained, including
  working sessions and direct framework-feedback reports.
