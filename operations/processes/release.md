...
A release packages a coherent state of the primary framework artifact and its
supporting examples. It does not turn operational notes or examples into
...
3. Update `artifacts/framework/CHANGELOG.md` for normative changes.
4. Update example documentation when a framework change would otherwise make
   an example misleading or invalid.
5. Compile stable stewardship learning and record remaining gaps honestly.
