...
APSS (Adaptive Problem-Solving Systems) is a framework for systems that solve
...
than replace it. Use APSS to organize and perform your own work in this
...
Read `framework/README.md` for how APSS works and `framework/VOCABULARY.md` for
its concepts.

The current APSS implementation used to improve the framework is
